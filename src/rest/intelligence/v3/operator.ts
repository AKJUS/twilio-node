...
export class OperatorContextImpl implements OperatorContext {
  ...
  fetch(
    ...
    operationPromise = operationPromise.then(
      (payload) =>
        new OperatorInstance(operationVersion, payload, instance._solution.id)
    );
  ...
  updateWithHttpInfo(
    ...
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion
      .updateWithResponseInfo<OperatorResource>({
        uri: instance._uri,
        method: "put",
        data,
        headers,
...
type OperatorResource =
  | CreateOperator201Response_ResponseResource
  | LanguageOperator_ResponseResource;
...
export function OperatorListInstance(version: V3): OperatorListInstance {
  ...
  instance.create = function create(
    ...
    operationPromise = operationPromise.then(
      (payload) => new OperatorInstance(operationVersion, payload)
    );
  ...
  instance.createWithHttpInfo = function createWithHttpInfo(
    ...
    // CREATE, FETCH, UPDATE operations
    let operationPromise = operationVersion
      .createWithResponseInfo<OperatorResource>({
        uri: instance._uri,
        method: "post",
        data,
        headers,
...
export class OperatorPage extends TokenPage<
  V3,
  OperatorPayload,
  OperatorResource,
  OperatorInstance
